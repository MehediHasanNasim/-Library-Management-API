...
DJOSER = {
    'USER_ID_FIELD': 'id',
    'LOGIN_FIELD': 'email',  # Adjust if you want to use `email` as the login field
    'SERIALIZERS': {
        'user_create': 'library.serializers.UserCreateSerializer',  # Use custom user creation serializer
